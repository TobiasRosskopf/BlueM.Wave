...
Namespace Fileformats
    ...
    Public Class UnRunOff_fort15
        ...
        ''' <summary>
        ''' Time step between two values in seconds
        ''' </summary>
        ...
        ''' <summary>
        ''' Instanciates a new UnRunOff fort15 file
        ''' </summary>
        ...
        Public Shared Function verifyFormat(file As String) As Boolean
            ...
            If Not filename.EndsWith(".15") Then Return False
            ...
            'Check if first line starts with "1"
            If Not syncReader.ReadLine.ToString.Trim().StartsWith("1") Then Return False
        ...
        Public Overrides Sub readSeriesInfo()
            ...
            Dim columnNames() As String = syncReader.ReadLine.Split(New Char() {Separator.ToChar}, System.StringSplitOptions.RemoveEmptyEntries)
        ...
        Public Overrides Sub readFile()
            ...
            Dim dlg_refDate As New ReferenceDateDialog()
            dlg_refDate.ShowDialog()
            refDate = dlg_refDate.DateTimePicker_refDate.Value

            'Show dialog for setting the time step
            Dim dlg_timeStep As New TimeStepDialog()
            dlg_timeStep.ShowDialog()
            timeStep = CInt(dlg_timeStep.TextBox_timeStep.Text)
            ...
            Do
                'Get values and datetime (calculate from reference date and time step)
                Dim values = syncReader.ReadLine.Split(New Char() {Separator.ToChar}, System.StringSplitOptions.RemoveEmptyEntries)
                Dim datetime = refDate + New TimeSpan(0, 0, Helpers.StringToDouble(timeStep * values(DateTimeColumnIndex)))
